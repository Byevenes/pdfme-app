...
export const getFontsData = async () => {
  const fontObjList: Font = {
    notoSansJP_Regular: {
      data: await fetch("fonts/NotoSansJP-Regular.ttf").then((res) =>
        res.arrayBuffer()
      ),
    },
    notoSansJP_Bold: {
      data: await fetch("fonts/NotoSansJP-Bold.ttf").then((res) =>
        res.arrayBuffer()
      ),
      fallback: true,
    },
